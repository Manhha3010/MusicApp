...
import {fetchArtistDetail} from '../../components/Request/http';
const windowWidth = Dimensions.get('window').width;
export function ArtistDetailScreen(props) {
    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <View>
        ...
        <Text
          ...
          {dataFetch?.ablumsAmount} Albums {'\t'} {dataFetch?.songsAmount} Songs
        </Text>
        <View
          style={{
